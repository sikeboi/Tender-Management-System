   ...
   <div class="col-md-8">
    <div class="marquee" style="border:2px black hidden; background-color:white">
        ...
        <div class="marquee-content" style="align:center; padding-top:200px;min-height:750px;background-color:cyan">
     		<h1><center>Greetings! Welcome to Our Tender Management system</center></h1>
     		<h2><center>You can manage,view and bid for tenders according to their deadline and base price</center></h2>
     		
     		<h3><center>You can also update your profile, change password and can do various other things</center></h3>
